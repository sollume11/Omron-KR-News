...
SYS_TRANSLATE = """전문 번역가입니다. 아래 한국어 뉴스 JSON을 일본어로 번역하세요.
JSON 구조 유지. title/summary/insight만 일본어로, source/url/date/importance는 그대로.
JSON만 출력(마크다운 없이). 자연스러운 비즈니스 일본어로."""
